...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const holdersCount = parseInt(this.dataset.holdersCount) || 0;
            ...
            let modalContent = `
                ...
                <h5 class="text-center mb-3">「${skillName}」を削除しますか？</h5>
            `;
            ...
            if (holdersCount > 0) {
                modalContent += `
                    <div class="alert alert-danger">
                        ...
                        <strong>注意:</strong> このスキルは現在 <strong>${holdersCount}人</strong> が習得しています。<br>
                        削除すると、これらのユーザーからスキルが取り消されます。
                    </div>
                `;
            }
    ...
    if (confirmDeleteBtn) {
        confirmDeleteBtn.addEventListener('click', function() {
            ...
            // APIを呼び出してスキル削除
            fetch(`/salary/admin/skills/${currentSkillId}/delete/`, {
                method: 'POST',
                headers: {
